...
南信大（NUIST）选课系统的自动化抢课工具。**当前版本 v2.2**（bug fix）：Avalonia 单进程应用（C#），无边框窗口 + 终末地工业风 UI（亮黄 `#FEFE2C` × 重黑 `#212121`），鸿蒙黑体已内嵌。支持多备选志愿队列、定时开抢、满员自动切备选、通识课志愿填报，抢课结果以 **WebSocket 服务器推送** 为最终裁决。
...
👉 到 [**Releases**](../../releases) 下载 `nuist-xsxk-helper-v2.2-win-x64.zip`，解压后双击 **南信大选课助手.exe** 即可。
